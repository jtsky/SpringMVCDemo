...
<header class="am-topbar am-topbar-fixed-top">
    <div class="am-topbar-left am-hide-sm-only">
        <a href="<%=request.getContextPath()%>/mvc/home" class="logo">
            <span>Go<span>Home</span></span>
    ...
    <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            ...
            <ul class="am-list admin-sidebar-list">
                <li><a href="<%=request.getContextPath()%>/mvc/home"><span class="am-icon-home"></span> 首页</a></li>
                ...
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
                        <li><a href="<%=request.getContextPath()%>/mvc/listActionLog" class="am-cf">行为日志表</a></li>
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="am-g">
                        ...
                        <div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;"
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/static/images/avatar-1.jpg"
                                                                     class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/static/images/avatar-2.jpg"
                                                                     class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/static/images/avatar-10.jpg"
                                                                     class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/static/images/avatar-4.jpg"
                                                                     class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="/static/images/avatar-5.jpg"
                                                                     class="img-circle"
                                                                     alt=""></div>
                ...
                <div class="am-u-md-8">
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">最近访问</h4>

                        <div class="am-scrollable-horizontal am-text-ms" style="font-family: '微软雅黑';">
                            <table class="am-table   am-text-nowrap" id="log-table">
                                <thead>
                                <tr>
                                    <th>序号</th>
                                    <th>访问者</th>
